...
FIXTURE_MATRIX_DECLARATION: Final[dict[str, dict[str, Any]]] = {
    "paths-at-least-two-sizes": {
        ...
        "observed_sizes": [2, 6, 7, 8, 9, 10, 14, 20],
        "observed_gate_ids": ["GA-03", "GA-05", "GA-06", "GA-17", "GA-19"],
    },
    "even-cycle": {
        "declared_covered": True,
        "observed_sizes": [10],
    ...
    "complete-with-repeated-eigenspace": {
        "declared_covered": True,
        "observed_sizes": [5, 6],
        "observed_gate_ids": ["GA-06", "GA-07", "GA-09", "GA-11", "GA-13", "GA-16"],
    },
    "disconnected-union": {
        "declared_covered": True,
        "observed_sizes": [6],
        "observed_gate_ids": ["GA-06", "GA-07", "GA-09", "GA-34"],
    },
    "random-undirected-positive-nonuniform-weights": {
        "declared_covered": False,
        "observed_sizes": [],
        "observed_gate_ids": [],
        "excluded_evidence": ["hand-constructed-weighted-6"],
    },
    "equal-sized-nonisomorphic-pair": {
        "declared_covered": True,
        "observed_sizes": [10],
    ...
    "asymmetric-directed-knn-policy-input": {
        ...
        "observed_sizes": [],
        "observed_gate_ids": [],
        "excluded_evidence": ["asymmetric-single-edge-input"],
    },
    "negative-weight-policy-input": {
        "declared_covered": True,
        "observed_sizes": [2],
...
EXACT_MULTILEVEL_MATRIX: Final[dict[str, dict[str, Any]]] = {
    ...
    "even-cycle": {
        ...
        "observed_depths": [],
        "complete": False,
        "missing": ["fixture", "all-required-depths"],
    },
    "odd-cycle-with-repeated-eigenvalues": {
        "required_sizes_minimum": 1,
        "required_depths": [1, 2, 4, 8, 16],
...
ROW_MATRIX_DECLARATION: Final[dict[str, dict[str, Any]]] = {
    "GA-03": {
        "dimension": "required-fixture-matrix",
        "required": list(REQUIRED_FIXTURE_MATRIX),
        "observed": ["paths-at-least-two-sizes"],
    },
    "GA-04": {
        "dimension": "required-fixture-matrix",
        "required": list(REQUIRED_FIXTURE_MATRIX),
...
ROOT_FIXTURE_DECLARATION: Final[dict[str, dict[str, Any]]] = {
    "real-interior": {
        ...
        "observed_gate_ids": ["GA-06", "GA-07", "GA-09", "GA-32", "GA-34"],
        "acceptance_complete": False,
        "missing": ["applicable-row-matrix-not-enumerated"],
    },
    "generic-complex": {
        "presence_observed": True,
        "observed_gate_ids": ["GA-02", "GA-06", "GA-07", "GA-09", "GA-24"],
        "acceptance_complete": False,
        "missing": ["applicable-row-matrix-not-enumerated"],
    },
    "multi-root-product": {
        "presence_observed": True,
        "observed_gate_ids": ["GA-02", "GA-03", "GA-05", "GA-06", "GA-24"],
        "acceptance_complete": False,
        "missing": ["applicable-row-matrix-not-enumerated"],
    },
    "conjugate-symmetric-pair-where-relevant": {
        ...
        "observed_gate_ids": [],
        "acceptance_complete": False,
        "missing": ["fixture", "applicable-row-matrix-not-enumerated"],
    },
    "near-radius-cap": {
        "presence_observed": True,
        "observed_gate_ids": ["GA-01", "GA-02"],
        "acceptance_complete": False,
        "missing": ["applicable-row-matrix-not-enumerated"],
    },
...
ID_FIXTURES: Final[dict[str, tuple[str, ...]]] = {
    "GA-00": ("invalid-graph-cases", "reciprocal-mean-with-isolates"),
    ...
    "GA-25": ("five-point-distinct-spectrum",),
    "GA-26": ("synthetic-repeated-eigenvalue",),
    "GA-27": ("scalar-reduced-pole",),
...
ID_ROOTS: Final[dict[str, tuple[str, ...]]] = {
    ...
    "GA-02": ("generic-complex", "near-cap", "multi-root"),
    "GA-03": ("multi-root",),
    "GA-05": ("multi-root",),
    "GA-06": ("real-interior", "generic-complex", "multi-root"),
    "GA-07": ("real-interior", "generic-complex", "multi-root"),
    "GA-09": ("real-interior", "generic-complex", "multi-root"),
