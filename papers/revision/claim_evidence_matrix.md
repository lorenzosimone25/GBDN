...
|---|---|---|---|---|
| Root admissibility, mapped zero/pole geometry, and Lorentzian phase law | THEOREM | Radial and optional bounded center-width roots; GA-01/02/23 | Proof draft and executable rows pass; exact interpolation attribution and final review remain open | PAPER-BLOCKED |
...
| Finite-Chebyshev operator error and multilevel frame defect | THEOREM | True full-operator errors and predicted `Delta_D`; GA-18--22 | Repaired approximation, synthesis, frame, and degree-128 oracle rows pass locally | PAPER-BLOCKED pending provenance, source attribution, and review |
