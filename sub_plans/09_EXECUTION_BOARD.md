...
| REV-GATEA-REVIEW-2 | Independently re-adjudicate repaired Gate A | Reviewer | ENG-GATEA-SEMANTIC-REPAIR-1 | Clean-commit binary Gate-A decision | IN_PROGRESS |
...
| OPS-H100-PREFLIGHT-1 | Audit the submission runner/notebook gap without executing experiments | Reviewer | OPS-RUNID-1 | Read-only implementation sequence and H100-only publication scope | IN_PROGRESS |
